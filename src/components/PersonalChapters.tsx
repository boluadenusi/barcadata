    ...
    return <section className="personal-section container section-space" aria-labelledby="personal-title">
        ...
        <div className="personal-grid">
            <article className="personal-note manager-note">
                ...
                <p className="note-kicker">The manager when you arrived</p><h3>{manager?.name ?? 'A different chapter'}</h3><p className="note-description">{manager?.note ?? 'Your birthday sits outside our manager records, which run from May 1988 to May 2025. The love for the club needs no starting date.'}</p>
            </article>
