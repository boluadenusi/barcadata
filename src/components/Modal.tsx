...
export function Methodology({ onClose }: { onClose: () => void }) {
  return <Modal title="A feeling. Backed by facts." onClose={onClose} className="methodology-modal">
    ...
    <div className="method-grid">
      <div><span className="eyebrow">THE MATCHES</span><h3>1,224 little stories.</h3><p>Every FC Barcelona men’s first-team LaLiga match from September 1993 to May 2025. That’s 32 complete seasons, sourced from <a href="https://www.football-data.co.uk/spainm.php" target="_blank" rel="noreferrer">Football-Data.co.uk</a>.</p></div>
      <div><span className="eyebrow">THE SILVERWARE</span><h3>Three competitions.</h3><p>LaLiga, Champions League, and Copa del Rey titles secured from 1993 to May 2025. We use the day a title was won. Super cups are excluded. <a href="https://www.fcbarcelona.com/en/football/first-team/honours" target="_blank" rel="noreferrer">Club honours</a></p></div>
    </div>
    <h3>Your birthday sets the starting line.</h3><p>Matches and honours on your birthday count. If you were born before September 1993, your league record starts with the available archive. If you were born after May 2025, we show an empty record. This is a historical snapshot, not a live feed.</p>
    <h3>A few more things worth knowing.</h3><p>The player closest to your age is chosen from 81 Barça players. Manager history starts in May 1988. “Nights we carry” is a curated selection of 20 moments from 1989 onward, across competitions, so those cup matches are separate from your LaLiga totals.</p>
