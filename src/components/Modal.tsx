...
export function Methodology({ onClose }: { onClose: () => void }) {
  return <Modal title="A feeling. Backed by facts." onClose={onClose} className="methodology-modal">
    ...
    <h3>A few more things worth knowing.</h3><p>The player closest to your age is chosen from 100 Barça players aged 25–40. Manager history starts in July 1917. “Nights we carry” is a curated selection of 20 moments from 1989 onward, across competitions, so those cup matches are separate from your LaLiga totals.</p>
