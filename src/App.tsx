  ...
  return <>
    ...
    <main id="main" className={!birthday ? 'pre-entry' : undefined}>
      ...
      {birthday && <div className="page-stack">
        ...
        <div className="chapter-band"><span>BARÇA IS THE CONSTANT.</span><span>YOU ARE THE VARIABLE.</span><span aria-hidden="true">✳</span><span>MÉS QUE UN NÚMERO.</span><span>MORE THAN A NUMBER.</span></div>
